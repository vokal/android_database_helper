...
public class ObjectCursorLoader<T> extends AsyncTaskLoader<ObjectCursor<T>> {
    ...
    public ObjectCursorLoader(Context context, Uri uri, CursorCreator<T> factory) {
        this(context, uri, null, null, null, null, factory);
    }
    ...
    public abstract static interface Callbacks<T> extends LoaderManager.LoaderCallbacks<ObjectCursor<T>> {}
}
